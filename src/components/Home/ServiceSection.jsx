...
const services = [
  {
    ...
    title: "MOBILE DIAGNOSTICS & REPAIR",
    desc: "Advanced engine diagnostics and roadside repairs across Nottinghamshire. We bring the garage to you, identifying faults and fixing issues on-site to get you back on the road fast.",
    image: "/services/diagnostics.avif",
    path: "/services/diagnostics-repair",
  },
  {
    // Color Reference: text-[#B62025] dark:text-[#FF4B4B]
    title: "FULL SYSTEM SERVICING",
    desc: "Comprehensive oil, filter, and fluid changes tailored to your manufacturer’s schedule. Professional maintenance at your doorstep to preserve your engine life and warranty.",
    image: "/services/servicing.avif",
    path: "/services/full-service",
  },
  {
    // Color Reference: text-[#B62025] dark:text-[#FF4B4B]
    title: "BRAKE & SUSPENSION CARE",
    desc: "Expert replacement of brake pads, discs, and suspension components. Ensuring your vehicle’s safety and handling with high-quality parts and precision mobile fitment.",
    image: "/services/brakes.avif",
    path: "/services/brakes-suspension",
  },
];
        ...
        <div className="relative overflow-hidden">
          ...
          >
            {services.map((service, index) => (
             ...
             hover:scale-105 active:scale-105 bg-black/10 hover:shadow-primary hover:border-primary/80 dark:bg-black/10 transition-all duration-300"
                data-aos="fade-up"
